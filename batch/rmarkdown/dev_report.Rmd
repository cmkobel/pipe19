...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, out.width = "100%", dev = c("svglite"))
```
...
VOCs <- c("B.1.1.7", "B.1.351", "P.1", "A.23.1", "B.1.525")
...
mutations_wide %>% 
  filter(lineage %in% c("B.1.177", "B.1.177.12", "B.1.177.21")) %>% 
  upset(nsets = 27, nintersects = 30, order.by = "freq", 
